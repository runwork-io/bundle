...
class BundleCreatorCliTest {
    ...
    fun createBundle_detectsFileTypes() {
        ...
        assertEquals(io.runwork.bundle.manifest.FileType.JAR, jarFile.type)
        assertEquals(io.runwork.bundle.manifest.FileType.NATIVE, nativeFile.type)
        assertEquals(io.runwork.bundle.manifest.FileType.RESOURCE, resourceFile.type)
    }
