 ...
 *
 * Usage:
 *   ./gradlew :bundle:run --args="--input <dir> --output <dir> --platform <platform> --private-key-env <env> [--build-number <num>]"
 *   ./gradlew :bundle:run --args="--input <dir> --output <dir> --platform <platform> --private-key-path <path> [--build-number <num>]"
 *   ./gradlew :bundle:run --args="--generate-keys"
 */
...
private fun generateKeys() {
    ...
    println("  3. Embed the public key in your shell application's BundleConfig")
}
